 ...
 */
adminSchema.methods.resetFailedLoginAttempts = function (): void {
 ...
 */
adminSchema.methods.incrementFailedLoginAttempts = function (): void {
 ...
 */
adminSchema.methods.updateLastLogin = function (ipAddress?: string, agent?: string): void {
  this.lastLogin = {
    time: new Date(),
    ipAddress,
    agent,
 ...
 * @returns Promise<IUser | null> - User document or null
 */
adminSchema.statics.findByMobileNumber = function (mobileNumber: string) {
 ...
 * @returns Promise<IUser | null> - User document or null
 */
adminSchema.statics.findByWalletId = function (walletId: string) {
...
const adminModel = mongoose.model<IUser>('admins', adminSchema);
